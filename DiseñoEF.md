...
análisis factorial. KMO Estrato\_s= 0,72 (Middling) KMO Gana\_mes= 0,76
(Middling) KMO N\_Carros= 0,82 (Meritorious)
...
grafica plot(acp, labels=row.names(r), cex=.7, ylim=c(-.8,.8))
